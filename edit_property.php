...
{
	$id = $_GET['id'];
	$propertyqry=mysqli_fetch_assoc(mysqli_query($conn,"select * from property where id = $id"));
	$address1 = $propertyqry['address1'];
	$address2=$propertyqry['address2'];
	$city=$propertyqry['city'];
	$state=$propertyqry['state'];
	$pincode=$propertyqry['pincode'];
}
//print_r($_POST);
if(isset($_POST['submit']))
{
	...
	if($status)
		{
			$sqll = "UPDATE property SET address1='$address1', address2='$address2', city='$city', state='$state', pincode='$pincode' where id='$id'";
		}
...
<head>
	...
	<title>AUCTION - Edit Property</title>
                            ...
                            <div class="content table-responsive table-full-width">
                                ...
                                <table class="table table-hover">
									  <tr>
										...
										<tr>
										<td align="center" style="padding-top:50px; margin-left:150px;"><button type="submit" name="submit" class="btn btn-info btn-fill">Save</button>&nbsp;&nbsp;<button type="reset" class="btn btn-info btn-fill">Reset</button></td>
										</tr>
									</tr>
								</table>
							  </form>
